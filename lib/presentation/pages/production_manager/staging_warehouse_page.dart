...
/// سندات وارد من الرئيسي (المخزن المرحلي كمستلم)
...
/// سندات صادر للخلاط (المخزن المرحلي كمرسل)
...
class _StagingWarehousePageState extends ConsumerState<StagingWarehousePage>
  ...
  void _refresh() {
    ref.invalidate(stagingInventoryProvider);
    ref.invalidate(stagingIncomingProvider);
    ref.invalidate(stagingOutgoingProvider);
...
class _InventoryTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(stagingInventoryProvider);
          ...
          return const Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text('انتظر استلام مواد من المخزن الرئيسي',
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final m = items[i];
                  return _buildMaterialCard(m, Colors.deepOrange);
                },
              ),
            ),
          ],
...
// ──────────────────────────────────────────────────────────────────────────────
// تبويب وارد من الرئيسي (المخزن المرحلي كمستلم)
// ──────────────────────────────────────────────────────────────────────────────
...
class _IncomingTab extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(stagingIncomingProvider);
          ...
          return const Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text('انتظر إنشاء طلب من المخزن الرئيسي',
                    style: TextStyle(color: Colors.grey, fontSize: 12)),
              ],
            ),
          );
...
// ──────────────────────────────────────────────────────────────────────────────
// تبويب صادر للخلاط (المخزن المرحلي كمرسل)
// ──────────────────────────────────────────────────────────────────────────────
...
class _OutgoingTab extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(stagingOutgoingProvider);
...
// ──────────────────────────────────────────────────────────────────────────────
// بطاقة السند الوارد (المخزن المرحلي كمستلم - يظهر زر التأكيد)
// ──────────────────────────────────────────────────────────────────────────────
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'من: المخزن الرئيسي → المخزن المرحلي',
                style: TextStyle(
                  fontSize: 11,
                  color: Colors.blue,
...
// ──────────────────────────────────────────────────────────────────────────────
// بطاقة السند الصادر (المخزن المرحلي كمرسل - لا يظهر زر التأكيد)
// ──────────────────────────────────────────────────────────────────────────────
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                const Icon(Icons.arrow_upward, size: 16, color: Colors.deepOrange),
                const SizedBox(width: 4),
                Text(
                  voucher.voucherNumber ?? '',
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
            ...
            Padding(
              padding: const EdgeInsets.only(top: 4),
              child: Text(
                'من: المخزن المرحلي → مخزن الخلطات',
                style: TextStyle(
                  fontSize: 11,
                  color: Colors.deepOrange,
                  fontWeight: FontWeight.w500,
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        widget.showSuccess(context, '✅ تم إنشاء السند بنجاح (بانتظار الاستلام)');
        widget.onSaved();
      }
    } catch (e) {
      if (mounted) {
